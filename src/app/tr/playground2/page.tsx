  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center ">
        <div className="w-[50rem] h-96 rounded-3xl flex items-start justify-center border border-zinc-300">
            <div className="border border-amber-600 mt-10 flex flex-col font-medium">
                <div className="text-base mb-4">Collectibles</div>
                ...
                <motion.div 
                    layout 
                    className={`flex ${view === TYPE.CARD? 'items-start gap-[2.4rem]' : 'items-start gap-3'}`}
                    style={{
                        flexDirection: view === TYPE.CARD ? 'row' : 'column'
                    }}
                    transition={{
                        duration: 0.3,
                        ease: 'easeOut'
                ...
                >
                    ...
                    >
                        <motion.div 
                            ...
                            // }}
                            style={{
                                width: view === TYPE.CARD ? '161px' : '56px',
                                height: view === TYPE.CARD ? '161px' : '56px'
                            }}
                        >
                            <Image 
                        ...
                        <div className="flex flex-col text-sm">
                            <div className="mb-1">Skilled Fingers Series</div>
                            <div>0.855 <span className="text-[#838383]">ETH</span></div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col text-sm">
                            <div className="mb-1">Vibrant Vibes Series</div>
                            <div>0.209 <span className="text-[#838383]">ETH</span></div>
                        </div>
                        <div className="flex gap-1 ml-auto"
                            style={{
                                position: view === TYPE.CARD ? 'absolute' : 'relative',
