...
export default function AnimatedHalfCircles() {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-900 py-9">
       <svg width="1067" height="1050" viewBox="0 0 1067 1050" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle r="8" fill="#A972D9" opacity="0.8">
          <animateMotion
            ...
            path="M46.5,516.5 A487,487 0 0,0 1020.5,516.5 A487,487 0 0,0 46.5,516.5"
          />
        </circle>
        <circle r="8" fill="#A972D9" opacity="0.8">
        ...
        <circle r="8" fill="#A972D9" opacity="0.8">
          <animateMotion
            dur="8s"
            repeatCount="indefinite"
            path="M128.5,516 A405.5,405.5 0 0,0 939.5,516 A405.5,405.5 0 0,0 128.5,516"
          />
        </circle>
        <circle r="8" fill="#A972D9" opacity="0.8">
